...
class DESCompiler extends Component {
    ...
    permuteKey(key){
        ...
        let Kplus =[key.charAt(56),key.charAt(48),key.charAt(40),key.charAt(32),key.charAt(24),key.charAt(16),key.charAt(8),
            ...
            key.charAt(22),key.charAt(12),key.charAt(4),key.charAt(27),key.charAt(19),key.charAt(11),key.charAt(3)];
        console.log(Kplus);
        let keyString = '';
        ...
        for(var i=0;i<16;i++){
            if(i===0||i===1||i===8||i===15){
                ...
                cComplete[i+1] = this.stringShift(C0,2);
                dComplete[i+1] = this.stringShift(D0,2);
            }
        }
    ...
    desRounds(){
        ...
        console.log('Final String: '+sResult);
        ...
        console.log('R: '+globalVars.R);
        console.log('Lprev: '+globalVars.L);
        globalVars.L = Lcur;
        console.log('L: '+globalVars.L);
    ...
    decDesRounds(){
        for(var z=15; z>-1; z--){
            console.log("DECRYPTIPION R, L: " + globalVars.R +' '+ globalVars.L);
    
            let Lcur = globalVars.L;
    
            let ERx = this.permuteR(globalVars.L);
            ...
            globalVars.L = this.XOR(fString, globalVars.R);
            console.log('Rprev: '+globalVars.R);
            console.log('L: '+globalVars.L);
            globalVars.R = Lcur;
            console.log('R: '+globalVars.R);
            console.log("Step Complete!");
            }
            let RLString = globalVars.L.concat(globalVars.R);
            //            Final Permutation
            // 40     8   48    16    56   24    64   32 //
            // 39     7   47    15    55   23    63   31 //
            // 38     6   46    14    54   22    62   30 //
    ...
    Encrypt(){
        ...
        this.permuteKey(this.state.key);
